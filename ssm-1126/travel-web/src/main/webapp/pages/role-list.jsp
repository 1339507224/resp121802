							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="v">
									<c:if test="${v==pageInfo.pageNum}">
										<li><a style="background-color: #00c0ef" href="${pageContext.request.contextPath}/role/findAll.do?page=${v}&pageSize=${pageInfo.pageSize}">${v}</a></li>
									</c:if>
									<c:if test="${v!=pageInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${v}&pageSize=${pageInfo.pageSize}">${v}</a></li>
									</c:if>
								</c:forEach>
