...
<body class="hold-transition skin-purple sidebar-mini">
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="v">
									<c:if test="${v==pageInfo.pageNum}">
										<li><a style="background-color: #00c0ef" href="${pageContext.request.contextPath}/product/findAll.do?page=${v}&pageSize=${pageInfo.pageSize}">${v}</a></li>
									</c:if>
									<c:if test="${v!=pageInfo.pageNum}">
									<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${v}&pageSize=${pageInfo.pageSize}">${v}</a></li>
									</c:if>
								</c:forEach>
	...
	<script>
		...
		function onStatus() {
			...
			var ids = selectedPowerIds.join(",");
			location.href="${pageContext.request.contextPath}/product/onStatus.do?ids="+ids;
		}
		function offStatus() {
			var selectedPowerIds = new Array();
			$(":checkbox[name=ids]:checked").each(function () {
			...
			var ids = selectedPowerIds.join(",");
			location.href="${pageContext.request.contextPath}/product/offStatus.do?ids="+ids;
		}
	</script>
</body>
