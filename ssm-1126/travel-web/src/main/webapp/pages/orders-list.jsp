...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="开启" onclick="onStatus()">
											<i class="fa fa-check"></i> 开启
										</button>
										<button type="button" class="btn btn-default" title="屏蔽" onclick="offStatus()">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
								<c:forEach begin="1" end="5" var="pp">
									<c:if test="${pp==pageInfo.pageSize}">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="v">
								<c:if test="${v==pageInfo.pageNum}">
									<li><a style="background-color: #00c0ef" href="${pageContext.request.contextPath}/orders/findAll.do?page=${v}&pageSize=${pageInfo.pageSize}">${v}</a></li>
								</c:if>
                                <c:if test="${v!=pageInfo.pageNum}">
								<li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${v}&pageSize=${pageInfo.pageSize}">${v}</a></li>
								</c:if>
							</c:forEach>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2014-2017 <a
				href="http://www.hyxy.cn">研究院研发部</a>.
	...
	<script>
		...
		function onStatus() {
			...
			var ids = selectedPowerIds.join(",");
			location.href="${pageContext.request.contextPath}/orders/onStatus.do?ids="+ids;
		}
		function offStatus() {
			var selectedPowerIds = new Array();
			$(":checkbox[name=ids]:checked").each(function () {
			...
			var ids = selectedPowerIds.join(",");
			location.href="${pageContext.request.contextPath}/orders/offStatus.do?ids="+ids;
		}
